...
func (c *cflmServiceClient) RpcHandleMsg(ctx context.Context, in *GrpcMsg, opts ...grpc.CallOption) (*GrpcReply, error) {
	out := new(GrpcReply)
	err := c.cc.Invoke(ctx, "/mgmt.cflmService/rpcHandleMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CflmService_RpcHandleMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mgmt.cflmService/RpcHandleMsg",
	}
...
var _CflmService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "mgmtsvc.proto",
}

func init() { proto.RegisterFile("mgmtsvc.proto", fileDescriptor_mgmtsvc_ccdcaa19be7d1ee2) }

var fileDescriptor_mgmtsvc_ccdcaa19be7d1ee2 = []byte{
	// 141 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0xcd, 0x4d, 0xcf, 0x2d,
	0x29, 0x2e, 0x4b, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x01, 0x71, 0xa5, 0xe4, 0xd3,
	...
	0x29, 0x17, 0x77, 0x72, 0x5a, 0x4e, 0x6e, 0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x90, 0x1a,
	0x17, 0x4f, 0x51, 0x41, 0xb2, 0x47, 0x62, 0x5e, 0x4a, 0x4e, 0xaa, 0x6f, 0x71, 0xba, 0x10, 0x87,
	0x9e, 0x7b, 0x51, 0x41, 0xb2, 0x6f, 0x71, 0xba, 0x14, 0x17, 0x98, 0x15, 0x94, 0x5a, 0x90, 0x53,
	0xa9, 0xc4, 0xe0, 0xc4, 0x11, 0xc5, 0xa6, 0x67, 0x0d, 0xb2, 0x2d, 0x89, 0x0d, 0x6c, 0x8e, 0x31,
	0x20, 0x00, 0x00, 0xff, 0xff, 0x2b, 0x49, 0x3a, 0x09, 0x8b, 0x00, 0x00, 0x00,
}
