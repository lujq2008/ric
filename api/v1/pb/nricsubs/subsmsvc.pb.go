...
// source: subsmsvc.proto

package subsm // import "."
...
func (c *cflmServiceClient) RpcHandleMsg(ctx context.Context, in *GrpcMsg, opts ...grpc.CallOption) (*GrpcReply, error) {
	out := new(GrpcReply)
	err := c.cc.Invoke(ctx, "/subsm.cflmService/rpcHandleMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CflmService_RpcHandleMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/subsm.cflmService/RpcHandleMsg",
	}
...
var _CflmService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "subsmsvc.proto",
}

func init() { proto.RegisterFile("subsmsvc.proto", fileDescriptor_subsmsvc_b0b68732ba3ab3d3) }

var fileDescriptor_subsmsvc_b0b68732ba3ab3d3 = []byte{
	// 142 bytes of a gzipped FileDescriptorProto
	,
}
