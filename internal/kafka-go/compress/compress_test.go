...
import (
	...
	kafka "nRIC/internal/kafka-go"
	pkg "nRIC/internal/kafka-go/compress"
	"nRIC/internal/kafka-go/compress/gzip"
	"nRIC/internal/kafka-go/compress/lz4"
	"nRIC/internal/kafka-go/compress/snappy"
	"nRIC/internal/kafka-go/compress/zstd"
	ktesting "nRIC/internal/kafka-go/testing"
)
