# kafka-go [![CircleCI](https://circleci.com/gh/segmentio/kafka-go.svg?style=shield)](https://circleci.com/gh/segmentio/kafka-go) [![Go Report Card](https://goreportcard.com/badge/nRIC/internal/kafka-go)](https://goreportcard.com/report/nRIC/internal/kafka-go) [![GoDoc](https://godoc.org/nRIC/internal/kafka-go?status.svg)](https://godoc.org/nRIC/internal/kafka-go)
...
`kafka-go` is currently compatible with golang version from 1.12+. To use with older versions of golang use release [v0.2.5](https://nRIC/internal/kafka-go/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/nRIC/internal/kafka-go?status.svg)](https://godoc.org/nRIC/internal/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/nRIC/internal/kafka-go?status.svg)](https://godoc.org/nRIC/internal/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/nRIC/internal/kafka-go?status.svg)](https://godoc.org/nRIC/internal/kafka-go#Writer)
...
#### [Plain](https://godoc.org/nRIC/internal/kafka-go/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/nRIC/internal/kafka-go/sasl/scram#Mechanism)
```go
